/* EastEnd46 — Header-Zustand, Navigation, Reveal, Scroll-Spy, Video, Jahr */
(function () {
  "use strict";
  ...
  /* Hero video: honor reduced motion (poster only) */
    ...
    var io = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          var el = entry.target, delay = Number(el.getAttribute("data-reveal-delay") || 0);
  ...
  /* Scroll-spy */
  var ids = ["start", "ueber", "leistungen", "ansatz", "kontakt"];
  var links = {};
  ids.forEach(function (id) { var a = document.querySelector('#primary-nav a[href="#' + id + '"]'); if (a) links[id] = a; });
